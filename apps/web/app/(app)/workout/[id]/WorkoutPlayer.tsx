...
export function WorkoutPlayer({ workout }: { workout: WorkoutData }) {
  ...
  return (
    <div className="min-h-screen pb-28" style={{ background: 'var(--bg)', color: 'var(--text)' }}>
      {/* ════════ STICKY HEADER ════════ */}
      <div className="border-b sticky top-0 z-30" style={{ borderColor: 'var(--border)', background: 'rgba(236,231,220,0.95)', backdropFilter: 'blur(20px)' }}>
      ...
      <div
        ...
        style={{
          background: 'rgba(236,231,220,0.97)',
